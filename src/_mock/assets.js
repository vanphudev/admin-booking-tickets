...
const MANAGEMENT_PERMISSION = {
   ...
   children: [
      ...
      },
      {
         id: '100024',
         parentId: '10002',
         label: 'sys.menu.management.way',
         name: 'Ways',
         type: PermissionType.MENU,
         route: 'way',
         component: '/management/way/index.tsx',
      },
      {
         id: '100025',
         parentId: '10002',
      ...
      },
      {
         id: '100026',
         parentId: '10002',
         label: 'sys.menu.management.refunds',
         name: 'Refunds',
         type: PermissionType.MENU,
         route: 'refunds',
         component: '/management/refunds/index.tsx',
      },
      {
         id: '100027',
         parentId: '10002',
   ...
   children: [
      {
         id: '100051',
         parentId: '10005',
         label: 'sys.menu.reports.trips',
         name: 'Trips',
         type: PermissionType.MENU,
         route: 'trips',
         component: '/reports/trips/index.tsx',
      },
      // {
      //    id: '100052',
      //    parentId: '10005',
      //    label: 'sys.menu.reports.refunds',
      //    name: 'Refunds',
      //    type: PermissionType.MENU,
      //    route: 'refunds',
      //    component: '/reports/refunds/index.tsx',
      // },
      // {
      //    id: '100053',
      //    parentId: '10005',
